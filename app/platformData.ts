...
export const updates: UpdateGroup[] = [
  {
    ...
    items: [
      {
        version: APP_VERSION,
        title: "주간 회의록 UI 및 업데이트 감지 개선",
        description: "주간 합산 HUD를 간결하게 줄이고 수기 입력을 검색형 선택 방식으로 바꿨으며, 특이사항 0건 생략·그 외 탭 분리·앱 종료 후 런처 즉시 업데이트 확인을 적용했습니다.",
      },
      {
        version: "2.1.6",
        title: "업무일지 특이사항 세부 항목 확장",
        description: "번호판·유리·발매트·타이어 교체, 기능 정비, 덴트, 복원, 틴팅, 데칼 제거, 내비/블박/후카, 실내클리닝 등 세부 항목을 업무일지에서 자동 인식해 주간 회의록에 합산합니다.",
      },
      {
        version: "2.1.5",
